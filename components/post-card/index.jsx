  ...
  return (
    <React.Fragment>
      <div className="bg-white shadow-lg rounded-lg p-0 lg:p-8 pb-8 lg:pb-12 mb-8">
        ...
        <h1 className="transition duration-700 text-center mb-4 lg:mb-8 cursor-pointer hover:text-pink-600 text-3xl font-semibold">
        ...
        <div className="text-center">
          <Link href={`/post/${encodeURIComponent(post.slug)}`}>
            <span className="transition duration-500 ease transform hover:-translate-y-1 hover:opacity-80 shadow-lg hover:shadow-cyan-500/50 inline-block bg-cyan-500 text-lg font-medium rounded-lg text-white px-8 py-3 cursor-pointer">Continue Reading</span>
          </Link>
        </div>
      </div>
    </React.Fragment>
